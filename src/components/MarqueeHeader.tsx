...
export default function MarqueeHeader() {
  return (
    <div className="w-full border-b-2 border-border bg-primary py-4 overflow-hidden">
      <Marquee speed={80} gradient={false} autoFill>
        <div className="flex items-center gap-12 text-primary-foreground font-bold text-2xl px-6">
